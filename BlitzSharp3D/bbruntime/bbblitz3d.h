...
/*extern Entity *  bbCreateCamera(Entity *p);
extern Entity *  bbCreateCube(Entity *p);
extern Entity *  bbCreateLight(int type, Entity *p);
extern void  bbPositionEntity(Entity *e, float x, float y, float z, int global);

extern void  bbUpdateWorld(float elapsed);
extern void  bbCaptureWorld();
extern void  bbRenderWorld(float tween);*/
